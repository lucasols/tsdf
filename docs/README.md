...
| `dynamicRealtimeThrottleMs`    | `(params) => number`                                                                                                      | No       | Overrides the manager default dynamic throttle for [real-time updates](./real-time-updates.md). Built-in manager default: `100ms` focused, `1000ms` background |
